...
public class Population {
    ...
    public Genome[][] selection(){
        ...
        for (int i = 0; i < 5; i++){
            pairs[i] = randomSelection(population, 3);
        }
    ...
    private Genome[] randomSelection(Genome[] population, int sizeOfTournament) {
    ...
    private Genome[] crossoverProportional(Genome parent1, Genome parent2) {
    ...
    private Genome[] crossover(Genome[][] pairs) {
        ...
        for (int i = 0; i < 10; i+=2) {
            ...
            result = crossoverProportional(firstParent, secondParent);
